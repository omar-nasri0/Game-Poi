...
function Card({ game }: { game: TypeGame[] }) {
  const xbox =
    ...
    <div className="flex flex-wrap justify-between">
      {game.map((val, i) => (
        <div key={i} className="flex flex-col h-[300px] items-start w-[250px] mt-4 relative">
          <div className="absolute top-[25px] left-[25px] z-10"><Add gameId={val.id} gameName={val.name} gameImageUrl={val.background_image}/></div>
          <img
          ...
          />
          <p className="mt-2 font-semibold line-clamp-1">{val.name}</p>
